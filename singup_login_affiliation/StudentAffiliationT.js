    ...
    form.addEventListener("submit", function(event) {
        ...
        if (isIdNumberValid) {
            ...
            request.onsuccess = function(event) {
                ...
                const objectStore = usersTransaction.objectStore("users");
                ...
                getUserRequest.onsuccess = function(event) {
                    ...
                    if (user && user.status === "student") {
                        const affiliationTransaction = db.transaction(["affiliation"], "readwrite");
                        const objectStore = affiliationTransaction.objectStore("affiliation");
                        ...
                        getAffiliationRequest.onsuccess = function(event) {
                            ...
                            if (affiliationData) {
                                displayAffiliationData(affiliationData.data);
